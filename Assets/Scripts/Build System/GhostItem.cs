...
namespace OvyKode
{
    public class GhostItem : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // Change to semi if in debug else full. We disable the solid box collider - while it is not yet placed (unless we are in construction mode - see update method)
